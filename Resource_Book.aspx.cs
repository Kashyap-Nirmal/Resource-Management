...
public partial class Resource_Book : System.Web.UI.Page
{
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
      ...
      // Response.Write(GridView1.SelectedRow.RowIndex.ToString());
       SqlCommand cmd = new SqlCommand("insert into Resource_Allocation values ('" + txtdate.Text + "','" + txtfromtime.Text + "','" + txttotime.Text + "'," + int.Parse(e.CommandArgument.ToString()) + ",'" + txtpurpose.Text + "',0," + int.Parse(DropDownList1.SelectedValue) + ") ", cn);
       cn.Open();
       cmd.ExecuteNonQuery();
       cn.Close();
